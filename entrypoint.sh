...
VER='2.1.1'
get_package "https://github.com/$FOO/$BAR/releases/download/v${VER}/${FOO}_${VER}_linux_amd64.tar.gz"
# get_package "https://github.com/$FOO/$BAR/releases/download/v${VER}/${FOO}_v${VER}_linux_amd64.tar.gz"
mkdir -p $BAR
